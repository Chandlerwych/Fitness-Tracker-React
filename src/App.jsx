  ...
  return <div>
    ...
    <div className="App">
      ...
      <Routes>
        ...
        <Route path="MyRoutines" element={<MyRoutines routines={routines} myRoutines={myRoutines} setRoutineDelete={setRoutineDelete} setRoutines={setRoutines} setMyRoutines={setMyRoutines} setToken={setToken} token={token} />}></Route>
